...
<body>
    ...
    <section id="review">
        ...
        <div class="upload-button-container hidden">
            <button class="upload-button" id="openModalBtn"><i class="fas fa-plus"></i>Tambahkan Ulasan Anda</button>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="rating-section">
                        <span class="rating-text">Beri Bintang</span>
                    ...
                    <div class="review-input">
                        <label for="review">Beri Ulasan</label>
                        <textarea id="reviewUser" rows="4" placeholder="Ketik Sesuatu..." name="ulasan"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="close btn-cancel" name="non_submit">Batal</button>
                    <button class="btn-delete btn-danger" name="hapus">Hapus</button>
                    <form action="{{ url('/review/' . $item->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <button class="btn-upload" name="submit">Simpan</button>
                    </form>
                </div>
            </div>
        </div>
